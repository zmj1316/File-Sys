...
//处理时间动作定义宏
//0-不处理，其它-处理
#define enable_time_transaction 1
...
struct attribute{
u16 access_time_year;
u8 access_time_month;
u8 access_time_day;

u16 create_time_year;
u8 create_time_month;
u8 create_time_day;
u8 create_time_hour;
u8 create_time_minute;
u8 create_time_second;


u16 modify_time_year;
u8 modify_time_month;
u8 modify_time_day;
u8 modify_time_hour;
u8 modify_time_minute;
u8 modify_time_second;

u8 attr;
};

#define The_DIRECTORY 0
#define The_FILE 1
